        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              ...
              <span style={{ fontSize: 10, color: "var(--turf)", fontFamily: "monospace" }}>{walletAddress}</span>
            </div>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: 14, color: "var(--text-muted)", maxWidth: 400 }}>
            Set NEXT_PUBLIC_PRIVY_APP_ID in .env.local. Get one free at{" "}
            <a href="https://privy.io" style={{ color: "var(--accent)" }}>privy.io</a>
          </p>
        </div>
      </div>
    );
