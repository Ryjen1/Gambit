    ...
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", background: "var(--background)" }}>
        ...
        <div style={{ maxWidth: 640, margin: "0 auto", display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8, alignItems: "center" }}>
                {quickPrompts.map((q) => (
                  <button key={q} onClick={() => sendMessage(q)} className="pill-btn" style={{
                    fontSize: 10, padding: "10px 20px", borderColor: "var(--border)",
                  }}>
                    {q}
                  </button>
                ))}
                      ...
                      <div key={k} style={{ display: "flex", justifyContent: "space-between", padding: "2px 0" }}>
                        ...
                        <span style={{
                          color: k.includes("p&l") || k.includes("potential") || k.includes("payout") || k === "status" || k === "analysis"
                            ? "var(--evidence-400)" : "var(--foreground)",
                        }}>{v}</span>
                      </div>
                    ))}
                  </div>
          ...
          {isTyping && (
            <div style={{ display: "flex", justifyContent: "flex-start" }}>
              <div className="chat-bubble-bot" style={{ padding: "14px 20px", display: "flex", gap: 6 }}>
      ...
      <div style={{ padding: "16px 24px", borderTop: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                background: input.trim() && !isTyping ? "var(--seal-500)" : "var(--muted)",
                display: "flex", alignItems: "center", justifyContent: "center",
          ...
          <p style={{
            textAlign: "center", fontSize: 10, color: "var(--muted-foreground)",
            marginTop: 8, fontFamily: "JetBrains Mono, monospace", letterSpacing: "0.05em",
          }}>
