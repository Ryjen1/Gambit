      ...
      <div style={{ position: "relative", zIndex: 10, textAlign: "center", maxWidth: 420 }}>
        ...
        <button
          ...
          style={{
            ...
            marginBottom: 24, opacity: ready ? 1 : 0.5,
          }}
        >
          {ready ? "SIGN IN TO PREDICT" : "LOADING..."}
        </button>
        ...
        <p style={{
          ...
          Sign in with email, Google, or wallet. Your wallet stays on your device.
          Powered by Aomi SDK.
        </p>
      </div>
    </div>
  ...
  return (
    <div className="noise" style={{ height: "100vh", display: "flex", flexDirection: "column", background: "var(--bg-base)", color: "var(--text-primary)" }}>
      ...
      <header style={{
        ...
        <button onClick={logout} className="font-display" style={{
...
// =============================================================================
// Page — Privy gate then Aomi chat
// =============================================================================
  ...
  if (!privyAppId) {
    return (
      <div style={{
        ...
        background: "var(--bg-base)", color: "var(--text-primary)", padding: 24, textAlign: "center",
      }}>
        <div>
          <h2 className="font-display" style={{ fontSize: 24, marginBottom: 12 }}>Missing Privy App ID</h2>
          <p style={{ fontSize: 14, color: "var(--text-muted)", maxWidth: 400 }}>
            Set <code>NEXT_PUBLIC_PRIVY_APP_ID</code> in your .env.local.
            Get one free at <a href="https://privy.io" style={{ color: "var(--accent)" }}>privy.io</a>
          </p>
        </div>
      </div>
    );
